...
def get_parametros_dict(db, claves: list) -> dict:
    ...
    try:
        ...
        # FIX: rollback defensivo. Sin esto, la conexión queda en transacción abortada
        # y TODA query posterior del mismo request falla en cascada (InFailedSqlTransaction),
        # provocando 500 en endpoints como /presupuesto/planificar.
        db.rollback()
        return {}
    finally:
        cur.close()